...
class ParserModel(Model):
    ...
    def add_prediction_op(self):
        ...
        Wshape = ((self.config.embed_size* self.config.n_features), self.config.hidden_size)
        Ushape = (self.config.hidden_size, self.config.n_classes)
        W = tf.Variable(xavier_initializer(Wshape))
        U = tf.Variable(xavier_initializer(Ushape))
